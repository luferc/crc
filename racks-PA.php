...
$db = dbase_open('./docs/racks-PA.dbf', 0); //dbase_open — Abre una base de datos en 0 solo lectura.
...
<div class='main-screenshot'>
    <a target="_blank" href="../crc/imag/CRC-UP.png">
  <img src="../crc/imag/CRC-UP.png" alt="Trilithics" width="450" height="500"> </a>
  </div>
